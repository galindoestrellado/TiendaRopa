...
namespace TiendaRopa.Tests.Repositories
{
    public class ProductoRepositoryTests
    {
        ...
        [Fact]
        public async Task GetById_EntityExists()
        {
            await ClearDBMemory();
        ...
        [Fact]
        public async Task GetAll_AllEntities()
        {
            await ClearDBMemory();
        ...
        [Fact]
        public async Task Add_AddEntity()
        {
            await ClearDBMemory();
        ...
        [Fact]
        public async Task Update_UpdateEntity()
        {
            await ClearDBMemory();
